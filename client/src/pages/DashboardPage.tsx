    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-sky-100 flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-2xl bg-white/80 backdrop-blur-md rounded-3xl shadow-2xl p-12 text-center border border-white">
        ...
        <h1 className="text-4xl md:text-5xl font-extrabold text-slate-800 tracking-tight leading-tight">
          GET READY TO MEET
          <span className="block text-indigo-600 mt-2 text-6xl italic tracking-tighter">Dr.AAra</span>
        </h1>
        ...
        <div className="mt-12 flex flex-col sm:flex-row gap-6 justify-center items-center relative z-20 pointer-events-auto">
          ...
          <Link to="/video-chat" className="group w-full sm:w-auto flex items-center justify-center gap-3 px-8 py-4 bg-indigo-600 hover:bg-indigo-700 text-white rounded-full font-semibold transition-all shadow-lg shadow-indigo-200 hover:-translate-y-1">
          ...
          <Link to="#" className="group w-full sm:w-auto flex items-center justify-center gap-3 px-8 py-4 bg-white hover:bg-slate-50 text-indigo-600 border-2 border-indigo-600 rounded-full font-semibold transition-all shadow-lg shadow-slate-200 hover:-translate-y-1">
            <svg className="w-6 h-6" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24">
        ...
        <button onClick={handleSignOut} className="mt-16 text-sm text-slate-400 hover:text-slate-600 transition-colors underline underline-offset-4 font-medium uppercase tracking-widest">
            Sign Out Securely
        </button>
      </div>
